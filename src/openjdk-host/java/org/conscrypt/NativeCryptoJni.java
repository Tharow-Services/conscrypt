...
class NativeCryptoJni {
  ...
  public static void init() {
    ...
    NativeLibraryLoader.loadFirstAvailable(NativeCrypto.class.getClassLoader(),
   ...
   * (https://github.com/trustin/os-maven-plugin). This plugin is used to generate platform-specific

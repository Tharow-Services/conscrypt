...
public class OpenSSLEngineImpl extends SSLEngine implements NativeCrypto.SSLHandshakeCallbacks,
    ...
    private final OpenSSLBIOSink localToRemoteSink = OpenSSLBIOSink.getInstance();
    ...
    public void beginHandshake() throws SSLException {
        ...
        try {
            ...
            handshakeSink = OpenSSLBIOSink.getInstance();
    ...
    public SSLEngineResult unwrap(ByteBuffer src, ByteBuffer[] dsts, int offset, int length)
        ...
        if (handshakeStatus == HandshakeStatus.NEED_TASK) {
            ...
            try {
                ...
                int ret = NativeCrypto.SSL_do_handshake_bio(sslNativePointer, sessionHolder,

...
public final class OpenSSLEngineImpl extends SSLEngine
    ...
    public boolean isOutboundDone() {
        ...
        return (NativeCrypto.SSL_get_shutdown(sslNativePointer) & SSL_SENT_SHUTDOWN)
                != 0;
    }
        ...
        try {
            ...
            if (src.isDirect()) {
                ...
                sslWrote = NativeCrypto.ENGINE_SSL_write_heap(
                    sslNativePointer, heapSrc.array(), heapSrc.arrayOffset() + pos, len,
                    this);
            }
            if (sslWrote > 0) {
        ...
        try {
            ...
            if (src.isDirect()) {
                ...
                netWrote = NativeCrypto.ENGINE_SSL_write_BIO_heap(sslNativePointer, networkBio,
                    heapSrc.array(), heapSrc.arrayOffset() + pos, len, this);
            }

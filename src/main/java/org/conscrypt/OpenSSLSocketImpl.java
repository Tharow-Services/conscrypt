...
public class OpenSSLSocketImpl
    ...
    private void notifyHandshakeCompletedListeners() {
        if (listeners != null && !listeners.isEmpty()) {
            ...
            HandshakeCompletedEvent event =
                new HandshakeCompletedEvent(this, sslParameters.getSession());
    ...
    public void verifyCertificateChain(long sslSessionNativePtr, long[] certRefs, String authMethod)
        ...
        try {
            ...
            sslParameters.handshakeSession = new OpenSSLSessionImpl(sslSessionNativePtr, null, peerCertChain,
    ...
    private class SSLOutputStream extends OutputStream {
        ...
        /**
         * Called from OpenSSLEngineImpl.
         */
        protected void wrap(OpenSSLBIOInputStream is) throws IOException {
            BlockGuard.getThreadPolicy().onNetwork();
            checkOpen();
            ...
            synchronized (writeLock) {
                ...
                NativeCrypto.SSL_write_BIO(sslNativePointer, is, OpenSSLSocketImpl.this);
            }
        }
    ...
    public SSLSession getSession() {
        ...
        if (sslSession == null) {
            try {
                waitForHandshake();
                sslSession = sslParameters.getSession();
            } catch (IOException e) {
    ...
    public void setChannelIdPrivateKey(PrivateKey privateKey) {
        ...
        if (privateKey == null) {
            ...
            sslParameters.channelIdPrivateKey = null;
        } else {
            sslParameters.channelIdEnabled = true;
            try {
                sslParameters.channelIdPrivateKey = OpenSSLKey.fromPrivateKey(privateKey);

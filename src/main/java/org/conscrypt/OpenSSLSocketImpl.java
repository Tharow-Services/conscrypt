...
public class OpenSSLSocketImpl
     ...
     * exchanges.
     */
    static String getServerKeyType(long sslCipherNative) throws SSLException {
        int algorithm_mkey = NativeCrypto.SSL_CIPHER_algorithm_mkey(sslCipherNative);
        int algorithm_auth = NativeCrypto.SSL_CIPHER_algorithm_auth(sslCipherNative);
        switch (algorithm_mkey) {
            case NativeCrypto.SSL_kRSA:
                return KEY_TYPE_RSA;
            case NativeCrypto.SSL_kDHr:
                return KEY_TYPE_DH_RSA;
            case NativeCrypto.SSL_kDHd:

...
public final class OpenSSLProvider extends Provider {
    ...
    public OpenSSLProvider() {
         ...
         * blocks. PKCS#5 technically supports only 64-bit
         * blocks and won't produce the same result as PKCS#7 for blocks that
         * are not 64 bits long. However, everybody assumes PKCS#7 when they
         * say PKCS#5. For example, lots of code uses PKCS#5 with AES whose
         * blocks are longer than 64 bits. We solve this confusion by making
         * PKCS7Padding an alias for PKCS5Padding.
         */

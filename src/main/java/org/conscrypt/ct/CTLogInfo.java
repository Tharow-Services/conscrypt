...
public class CTLogInfo {
     ...
     */
    public SCTVerificationResult.Status verifySingleSCT(SignedCertificateTimestamp sct,
        ...
        try {
            ...
            return SCTVerificationResult.Status.INVALID_SCT;
        }
        ...
        try {
            ...
            if (!signature.verify(sct.getSignature().getSignature())) {
                return SCTVerificationResult.Status.INVALID_SIGNATURE;
            }
            return SCTVerificationResult.Status.VALID;

    ...
    public static DigitallySigned decode(InputStream input)
        ...
        try {
            return new DigitallySigned(
                SerializationUtils.readNumber(input, CTConstants.HASH_ALGORITHM_LENGTH),
                SerializationUtils.readNumber(input, CTConstants.SIGNATURE_ALGORITHM_LENGTH),
                SerializationUtils.readVariableBytes(input, CTConstants.SIGNATURE_LENGTH_BYTES)
            );

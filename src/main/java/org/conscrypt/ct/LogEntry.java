...
public class LogEntry {
    ...
    public static LogEntry createForPrecertificate(OpenSSLX509Certificate[] chain)
        ...
        try {
            ...
            OpenSSLX509Certificate preCert = chain[0].deleteExtension(CTConstants.X509_SCT_LIST_OID);

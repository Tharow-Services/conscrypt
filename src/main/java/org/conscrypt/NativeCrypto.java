...
public final class NativeCrypto {
     ...
     * ALPN negotiation.
     */
    public static native int SSL_do_handshake_bio(long sslNativePointer,
                                                  long[] sslSessionHolder,
                                                  long readBioRef,
                                                  long writeBioRef,
                                                  SSLHandshakeCallbacks shc,
                                                  boolean client_mode,
    ...
    public static native void SSL_write_BIO(long sslNativePointer, OpenSSLBIOInputStream is,

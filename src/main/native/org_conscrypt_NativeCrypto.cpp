...
static jint NativeCrypto_SSL_CIPHER_algorithm_mkey(JNIEnv* env, jclass,
        jlong ssl_cipher_address)
{
    SSL_CIPHER* cipher = to_SSL_CIPHER(env, ssl_cipher_address, true);
    JNI_TRACE("cipher=%p SSL_CIPHER_algorithm_mkey => %ld", cipher, cipher->algorithm_mkey);
    return cipher->algorithm_mkey;
}

static jint NativeCrypto_SSL_CIPHER_algorithm_auth(JNIEnv* env, jclass,
        jlong ssl_cipher_address)
{
    SSL_CIPHER* cipher = to_SSL_CIPHER(env, ssl_cipher_address, true);
    JNI_TRACE("cipher=%p SSL_CIPHER_algorithm_auth => %ld", cipher, cipher->algorithm_auth);
...
static JNINativeMethod sNativeCryptoMethods[] = {
    ...
    NATIVE_METHOD(NativeCrypto, SSL_CIPHER_algorithm_auth, "(J)I"),
    NATIVE_METHOD(NativeCrypto, SSL_CIPHER_algorithm_mkey, "(J)I"),

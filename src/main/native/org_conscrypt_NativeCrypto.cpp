...
{
    SSL* ssl = to_SSL(env, ssl_address, true);
    JNI_TRACE("ssl=%p NativeCrypto_SSL_set_ocsp_response",
            ssl);
    if (ssl == NULL)  {
        return;
    }
    ...
    if (!SSL_set_ocsp_response(ssl,
        ...
        jniThrowRuntimeException(env, "SSL_set_ocsp_response failed");
    } else {
...
static JNINativeMethod sNativeCryptoMethods[] = {
    ...
    NATIVE_METHOD(NativeCrypto, SSL_set_ocsp_response, "(J[B)V"),

...
#else
static jlong NativeCrypto_ENGINE_by_id(
                JNIEnv* env __attribute__ ((unused)),
                jclass,
                jstring idJava __attribute__ ((unused))) {
    return 0;
}
#endif
...
#else
static jint NativeCrypto_ENGINE_add(
                JNIEnv* env __attribute__ ((unused)),
                jclass,
                jlong engineRef __attribute__ ((unused))) {
    return 0;
}
#endif
...
#else
static jint NativeCrypto_ENGINE_init(
                JNIEnv* env __attribute__ ((unused)),
                jclass,
                jlong engineRef __attribute__ ((unused))) {
    return 0;
...
#else
static jint NativeCrypto_ENGINE_finish(
                JNIEnv* env __attribute__ ((unused)),
                jclass,
                jlong engineRef __attribute__ ((unused))) {
    return 0;
...
#else
static jint NativeCrypto_ENGINE_free(
                JNIEnv* env __attribute__ ((unused)),
                jclass,
                jlong engineRef __attribute__ ((unused))) {
    return 0;
...
#else
static jstring NativeCrypto_ENGINE_get_id(
                JNIEnv* env,
                jclass,
                jlong engineRef __attribute__ ((unused)))
{
...
#else
static jint NativeCrypto_ENGINE_ctrl_cmd_string(
                JNIEnv* env __attribute__ ((unused)),
                jclass,
                jlong engineRef __attribute__ ((unused)),
                jstring cmdJava __attribute__ ((unused)),
                jstring argJava __attribute__ ((unused)),
                jint cmd_optional __attribute__ ((unused)))
{
    return 0;
}
#endif
...
#else
static int get_EC_GROUP_type(const EC_GROUP* group __attribute__ ((unused)))
{
    return EC_CURVE_GFP;
}
#endif
...
#else
static void NativeCrypto_EC_GROUP_set_asn1_flag(
                JNIEnv* env __attribute__ ((unused)),
                jclass,
                jobject groupRef __attribute__ ((unused)),
                jint flag __attribute__ ((unused)))
{
}
#endif
...
#else
static void NativeCrypto_EC_GROUP_set_point_conversion_form(
                JNIEnv* env __attribute__ ((unused)),
                jclass,
                jobject groupRef __attribute__ ((unused)),
                jint form __attribute__ ((unused)))
{
}
#endif
...
#else
static void NativeCrypto_EC_KEY_set_nonce_from_hash(
                JNIEnv* env __attribute__ ((unused)),
                jclass __attribute__ ((unused)),
                jobject pkeyRef __attribute__ ((unused)),
                jboolean enabled __attribute__ ((unused)))
{
}
#endif
...
#else
static void NativeCrypto_RAND_seed(
                JNIEnv* env __attribute__ ((unused)),
                jclass,
                jbyteArray seed __attribute__ ((unused))) {
}
#endif

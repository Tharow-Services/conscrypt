...
public class OpenSSLSocketImplTest extends TestCase {
    ...
    private X509Certificate CERT_EMBEDDED;
    private PrivateKey CERT_KEY;
    private CTVerifier CT_VERIFIER;

    private Field CONTEXT_SSL_PARAMETERS;
    ...
    public void test_handshake() throws Exception {
        TestConnection connection = new TestConnection(new X509Certificate[] { CERT, CA }, CERT_KEY);
    ...
    public void test_handshakeWithEmbeddedSCT() throws Exception {
        TestConnection connection = new TestConnection(new X509Certificate[] { CERT_EMBEDDED, CA }, CERT_KEY);

        connection.clientHooks.ctVerifier = CT_VERIFIER;

...
// We want the XSI-compliant strerror_r (it's more portable across NDK
// versions), not the GNU one. We haven't actually defined _GNU_SOURCE
// ourselves, but the compiler adds it automatically when building C++.
//

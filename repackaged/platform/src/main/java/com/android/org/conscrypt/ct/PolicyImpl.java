...
public class PolicyImpl implements Policy {
    ...
    public PolicyCompliance doesResultConformToPolicyAt(
        ...
        Set<VerifiedSCT> validSCTs = filterRetiredExpired(result.getValidSCTs());
    ...
    private Set<VerifiedSCT> filterRetiredExpired(List<VerifiedSCT> scts) {
        ...
        Set<VerifiedSCT> validSCTs = new HashSet<>();
        if (scts.size() < 1) {

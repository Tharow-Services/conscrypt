...
abstract class AbstractConscryptSocket extends SSLSocket {
     ...
     *         started.
     */
    @UnsupportedAppUsage abstract void setChannelIdEnabled(boolean enabled);
     ...
     */
    @UnsupportedAppUsage abstract byte[] getChannelId() throws SSLException;
     ...
     *         started.
     */
    @UnsupportedAppUsage abstract void setChannelIdPrivateKey(PrivateKey privateKey);

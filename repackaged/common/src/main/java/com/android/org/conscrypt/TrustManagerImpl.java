...
public final class TrustManagerImpl extends X509ExtendedTrustManager {
    ...
    private final com.android.org.conscrypt.ct.SubSystem ctSubSystem;
    ...
    private TrustManagerImpl(KeyStore keyStore, CertPinManager manager,
            ...
            com.android.org.conscrypt.ct.SubSystem ctSubSystem) {
        ...
        if (ctSubSystem == null) {
            ctSubSystem = Platform.newDefaultCTSubSystem();
        }
        if (blocklist == null) {
    ...
    private List<X509Certificate> verifyChain(List<X509Certificate> untrustedChain,
        ...
        try {
            ...
            if (!clientAuth && host != null && ctSubSystem != null
                    && ctSubSystem.isCTVerificationRequired(host)) {
                ctSubSystem.checkCT(wholeChain, ocspData, tlsSctData, host);
            }

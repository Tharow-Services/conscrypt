...
public abstract class OpenSSLCipherRSA extends CipherSpi {
    ...
    public static final class PKCS1 extends DirectRSA {
        public PKCS1() {
            ...
            Platform.countCipherUsage(MetricsCipher.RSAPKCS1.getId());
        }
    }
    ...
    public static final class Raw extends DirectRSA {
        public Raw() {
            ...
            Platform.countCipherUsage(MetricsCipher.RSARaw.getId());
        }
    }
    ...
    public static class OAEP extends OpenSSLCipherRSA {
        ...
        public static final class SHA1 extends OAEP {
            public SHA1() {
                ...
                Platform.countCipherUsage( MetricsCipher.SHA1.getId());
            }
        }
        ...
        public static final class SHA224 extends OAEP {
            public SHA224() {
                ...
                Platform.countCipherUsage( MetricsCipher.SHA224.getId());
            }
        }
        ...
        public static final class SHA256 extends OAEP {
            public SHA256() {
                ...
                Platform.countCipherUsage( MetricsCipher.SHA256.getId());
            }
        }
        ...
        public static final class SHA384 extends OAEP {
            public SHA384() {
                ...
                Platform.countCipherUsage( MetricsCipher.SHA384.getId());
            }
        }
        ...
        public static final class SHA512 extends OAEP {
            public SHA512() {
                ...
                Platform.countCipherUsage( MetricsCipher.SHA512.getId());
            }
        }
    }
}

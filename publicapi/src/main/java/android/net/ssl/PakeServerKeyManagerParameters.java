...
public final class PakeServerKeyManagerParameters implements ManagerFactoryParameters {
    ...
    /**
     * Returns a set of the endpoints.
     *
     * @return The known endpoints.
     */
    ...
    public static final class Builder {
        ...
        public @NonNull Builder addOption(
            ...
            // For SPAKE2PLUS_PRERELEASE, servers, if using "w0" and "registration_record" for
            // verification, must have both of them together. PakeOption already validates other
            // parts, like the usage of "password", or that not all of "w0", "w1" and
            // "registration_record" are present.
            if (option.getName().equals("SPAKE2PLUS_PRERELEASE")
                ...
                throw new InvalidParameterException("SPAKE2PLUS_PRERELEASE server needs "
                        + "registration_record when w0 is present");
            }

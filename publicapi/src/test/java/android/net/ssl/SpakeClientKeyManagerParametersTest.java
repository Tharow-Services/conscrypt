...
public class SpakeClientKeyManagerParametersTest {
    ...
    public void testBuilder() {
        ...
        assertArrayEquals(CLIENT_IDENTITY, params.getSpakeIdentity().getClientIdentity());
        assertArrayEquals(SERVER_IDENTITY, params.getSpakeIdentity().getServerIdentity());

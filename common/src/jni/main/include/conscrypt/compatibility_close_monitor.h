...
/*
 * If possible, hook into the (non-public) Android C API for AsynchronousCloseMonitor,
 * allowing Java thread wakeup semantics during POSIX system calls.  Currently only
 * used in sslSelect().
 *

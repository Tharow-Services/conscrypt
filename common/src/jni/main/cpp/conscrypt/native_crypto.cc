...
static JNINativeMethod sNativeCryptoMethods[] = {
        ...
        CONSCRYPT_NATIVE_METHOD(SSL_CTX_set_spake_credential_client, "([B[B[B[B[BZ" REF_SSL ")V"),
        CONSCRYPT_NATIVE_METHOD(SSL_CTX_set_spake_credential_server, "([B[B[B[B[BZ" REF_SSL ")V"),

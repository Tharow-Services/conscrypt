...
public class SubSystemTest {
    class NoPlatformSubSystem extends SubSystem {
        public NoPlatformSubSystem(
    ...
    public void testCheckCT() throws Exception {
        ...
        NoPlatformSubSystem subSys =
                new NoPlatformSubSystem(store, alwaysCompliantStorePolicy, verifier, statsLog);

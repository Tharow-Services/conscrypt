...
public class KeyFactoryTestRSA extends
    ...
    public void testInvalidKeySpec() throws Exception {
        ...
        try {
            factory.getKeySpec(new WrappedPrivateKey(DefaultKeys.getPrivateKey("RSA"), "Invalid"),
        ...
        try {
            factory.getKeySpec(new WrappedPublicKey(DefaultKeys.getPublicKey("RSA"), "Invalid"),

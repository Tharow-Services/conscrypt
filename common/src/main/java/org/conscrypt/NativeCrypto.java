...
public final class NativeCrypto {
    ...
    private static final Set<String> SUPPORTED_PROTOCOLS_TLSV1_SET =
        new HashSet<>(Arrays.asList(SUPPORTED_PROTOCOLS_TLSV1));
    ...
    static String[] checkEnabledProtocols(String[] protocols) {
        ...
        for (String protocol : protocols) {
            ...
            if (!SUPPORTED_PROTOCOLS_TLSV1_SET.contains(protocol)) {

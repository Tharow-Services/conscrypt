    ...
    public static final class PKCS1 extends DirectRSA {
        public PKCS1() {
            ...
            Platform.countCipherUsage(
                MetricsCipher.RSAPKCS1.getId(), 1);
        }
    }

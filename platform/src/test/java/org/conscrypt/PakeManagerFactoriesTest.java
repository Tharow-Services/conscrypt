...
public class PakeManagerFactoriesTest {
  ...
  public void testEngineInitParameters() throws InvalidAlgorithmParameterException {
    ...
    PakeClientKeyManagerParameters params = new PakeClientKeyManagerParameters.Builder().build();
  ...
  public void testEngineGetKeyManagers() throws InvalidAlgorithmParameterException {
    ...
    PakeClientKeyManagerParameters params = new PakeKeyManagerParameters
        .Builder()
    ...
    assertArrayEquals(password, keyManager.getOptions().getMessageComponent("password"));

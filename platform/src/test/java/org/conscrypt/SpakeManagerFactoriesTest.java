...
public class SpakeManagerFactoriesTest {
  ...
  public void testEngineInitParameters() throws InvalidAlgorithmParameterException {
    ...
    assertThrows(IllegalAccessError.class, () -> keyManagerFactory.engineInit(null, null));

    byte[] password = "password".getBytes();
    SpakeKeyManagerParameters params = new SpakeKeyManagerParameters.Verifier.Builder(password).build();
  ...
  public void testEngineGetKeyManagers() throws InvalidAlgorithmParameterException {
    ...
    assertThrows(IllegalAccessError.class, () -> factory.engineGetKeyManagers());
    ...
    SpakeKeyManagerParameters params = new SpakeKeyManagerParameters.Verifier
        .Builder(password)

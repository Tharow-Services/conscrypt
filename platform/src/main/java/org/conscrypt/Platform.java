...
final public class Platform {
    ...
    static org.conscrypt.ct.CertificateTransparency newDefaultCertificateTransparency() {
        org.conscrypt.ct.LogStore logStore = new org.conscrypt.ct.LogStoreImpl();
        return new org.conscrypt.ct.CertificateTransparency(logStore,
                new org.conscrypt.ct.PolicyImpl(), new org.conscrypt.ct.Verifier(logStore),
                getStatsLog());
    }
